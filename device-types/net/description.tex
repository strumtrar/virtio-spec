...
The driver fills \field{hash_value} with the value of the calculated hash and \field{hash_report}
with the report type of the calculated hash.

The following possible values for \field{hash_report} extend the supported hash types from
